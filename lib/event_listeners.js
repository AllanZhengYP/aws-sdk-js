    ...
    addAsync('SIGN', 'sign', function SIGN(req, done) {
      ...
      service.config.getCredentials(function (err, credentials) {
        ...
        try {
          ...
          // var date = service.getServiceClock();
          // var date = AWS.util.date.getDate();
          // console.log(new Error().stack);
          // console.log('____req: '+[req.httpRequest.method, req.httpRequest.path]);
          // console.log('____service: '+Object.keys(req.httpRequest));
          // console.log('____getClock: '+service.getServiceClock);
          // console.log(new Error().stack);
